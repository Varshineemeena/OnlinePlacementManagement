...
public class ApplicationDAOImpl implements ApplicationsDAO {
    ...
    public void updateApplicationsInfo(Applications applications) {
        try {
            ...
            .setParameter("student", applications.getStudent()).setParameter("job", applications.getJob()).setParameter("company", applications.getCompany()).setParameter("admin", applications.getAdmin())
            .executeUpdate();
