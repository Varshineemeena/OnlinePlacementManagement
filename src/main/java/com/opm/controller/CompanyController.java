    ...
    public String addCompany(@RequestBody Company company) {
	 ...
	 public ResponseEntity<String> register(@RequestBody Company company) {
	     try {
	         ...
	         if (company.getEmail() == null || company.getPassword() == null || company.getAddress() == null || company.getUrl() == null || company.getAddress() == null || company.getUrl() == null || company.getName() == null) {
